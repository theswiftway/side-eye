...
struct Animations {
    ...
    static let bounce = Animation.spring(response: 0.6, dampingFraction: 0.5, blendDuration: 0)
    static let springy = Animation.spring(response: 0.4, dampingFraction: 0.7, blendDuration: 0)
